...
def parse_transfun_results(result_file, goterms, prot_list):
    """Parse TransFun results into a numpy matrix aligned with prot_list and goterms."""
...
def main():
    ...
    FILE_MAPPING = {
        'cellular_component': 'SOTA_predictions/TransFun/cc_results.txt',
        'molecular_function': 'SOTA_predictions/TransFun/mf_results.txt',
        'biological_process': 'SOTA_predictions/TransFun/bp_results.txt'
    }
    
    results = {}
    
    for ont in ONTOLOGIES:
        print(f"\nEvaluating TransFun on {ont}...")
        ...
        y_pred = parse_transfun_results(res_file, goterms, prot_list)
